...
<html lang="en">
	...
	<body class="landing">
		...
		<!-- Header -->
			<header id="header">
				<h1><a href="./index.html" class="button special">OUR NAME</a></h1>
				<nav id="nav">
					<ul>
					...
					<script src="wickedpicker/src/wickedpicker.js"></script>
						...
						<div class="row uniform 50%">
							...
							<div id="bottomStuff">
								...
								<textarea name = "otherTextBox" id="descriptiontextBox" rows="3" cols="1" placeholder="Please provide a description of the place and or event."></textarea>
								</br>
